...
const OneTaskComponent = (props) => {
    ...
    <View >
        <View style={styles.oneTaskBox}>
            <TouchableOpacity onPress={props.projectLink}>
            ...
            <View style={styles.statusBox}>
                <View style={styles.statusBoxTimestampBox}>
                    ...
                    <Text style={styles.modifiedDate}>Updated: 12.10.2019</Text>
                </View>
                <TouchableOpacity style={styles.statusBoxStatus} onPress={props.taskLink}>
                    <Text style={{
                        fontSize: 20,
                        width: w / 2.4,
                        fontWeight: '700',
